...
class TechnicianCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => MaintenanceRecordCreateNestedManyWithoutTechniciansInput,
  })
  @ValidateNested()
  @Type(() => MaintenanceRecordCreateNestedManyWithoutTechniciansInput)
  @IsOptional()
  @Field(() => MaintenanceRecordCreateNestedManyWithoutTechniciansInput, {
    nullable: true,
  })
  maintenanceRecords?: MaintenanceRecordCreateNestedManyWithoutTechniciansInput;
}

export { TechnicianCreateInput as TechnicianCreateInput };
