...
@InputType()
class MaintenanceRecordUpdateManyWithoutTechniciansInput {
...
export { MaintenanceRecordUpdateManyWithoutTechniciansInput as MaintenanceRecordUpdateManyWithoutTechniciansInput };
