...
@InputType()
class MaintenanceRecordCreateNestedManyWithoutTechniciansInput {
...
export { MaintenanceRecordCreateNestedManyWithoutTechniciansInput as MaintenanceRecordCreateNestedManyWithoutTechniciansInput };
