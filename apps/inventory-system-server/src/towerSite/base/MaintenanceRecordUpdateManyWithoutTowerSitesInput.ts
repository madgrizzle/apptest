...
@InputType()
class MaintenanceRecordUpdateManyWithoutTowerSitesInput {
...
export { MaintenanceRecordUpdateManyWithoutTowerSitesInput as MaintenanceRecordUpdateManyWithoutTowerSitesInput };
