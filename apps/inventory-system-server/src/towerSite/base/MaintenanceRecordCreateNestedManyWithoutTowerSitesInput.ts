...
@InputType()
class MaintenanceRecordCreateNestedManyWithoutTowerSitesInput {
...
export { MaintenanceRecordCreateNestedManyWithoutTowerSitesInput as MaintenanceRecordCreateNestedManyWithoutTowerSitesInput };
